            ...
            <div class="Categories__WrapperCat">
                <li class="categoriesItem flex" onMouseOver={()=>handleMouseOverInLi(1)} onMouseOut={()=>handleMouseOutInLi(1)}>
                    ...
                    <div class="categoriesDropdownContent dropdown-content" id="num1">
                        <Link to={{pathname: '/totalItem',search: `?CategoryID=1`}} class="categoriesDropdownItem text-text">Căn hộ/Chung cư</Link>
                        <Link to={{pathname: '/totalItem',search: `?CategoryID=2`}} class="categoriesDropdownItem text-text">Nhà ở</Link>
                        <Link to={{pathname: '/totalItem',search: `?CategoryID=3`}} class="categoriesDropdownItem text-text">Đất</Link>
                        <Link to={{pathname: '/totalItem',search: `?CategoryID=4`}} class="categoriesDropdownItem text-text">Văn phòng, Mặt bằng kinh doanh</Link>
                    </div>
                </li>
                <li class="categoriesItem flex" onMouseOver={()=>handleMouseOverInLi(2)} onMouseOut={()=>handleMouseOutInLi(2)}>
                    ...
                    <div class="categoriesDropdownContent dropdown-content" id="num2">
                        <a to={{pathname: '/totalItem',search: `?backUrl=aaa`}} class="categoriesDropdownItem text-text">Căn hộ/Chung cư</a>
                        <a to={{pathname: '/totalItem',search: `?backUrl=aaa`}} class="categoriesDropdownItem text-text">Nhà ở</a>
                        <a to={{pathname: '/totalItem',search: `?backUrl=aaa`}} class="categoriesDropdownItem text-text">Nhà trọ</a>
                        <a to={{pathname: '/totalItem',search: `?backUrl=aaa`}} class="categoriesDropdownItem text-text">Văn phòng, Mặt bằng kinh doanh</a>
                    </div>
                </li>
            </div>
        </div>
